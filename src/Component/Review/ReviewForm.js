        ...
        <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2}>
                <Grid item sx={{ mt: 'auto', mb: 'auto' }} xs={12} md={6}>
                    <Typography variant="body1" gutterBottom>Product Review</Typography>
                    ...
                    </Container>} */}
                    {
                        !isLoading && <form onSubmit={handleOrderSubmit}>
                            ...
                            <TextField color='secondary' name='productname' onBlur={handleOnBlur} sx={{ width: "75%", m: 1, }} label="Product Name" type="text" variant="outlined" />
                            <TextField color='secondary' name='reviewtext' onBlur={handleOnBlur} sx={{ width: "75%", m: 1, }} label="Your Comments" type="text" variant="outlined" />


                            <Typography textAlign="">Rating<Rating
                            ...
                            <Button type="submit" color='success' sx={{ width: "75%", m: 1, }} variant="contained">Submit Review</Button>
                ...
                <Grid item xs={12} md={6}>
                    <img style={{ width: "80%" }} src='https://i.ibb.co/6B4NpQT/userreview-ai.png' alt=""></img>
                </Grid>
